...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    await _safeInitAsync(() async {
      _userPhoneNumber = await secureStorage.getString('ff_userPhoneNumber') ??
          _userPhoneNumber;
    });
    await _safeInitAsync(() async {
  ...
  set userPhoneNumber(String value) {
    ...
    secureStorage.setString('ff_userPhoneNumber', value);
  }

  void deleteUserPhoneNumber() {
    secureStorage.delete(key: 'ff_userPhoneNumber');
  }
