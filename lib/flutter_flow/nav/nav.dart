...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? LandingWidget() : HomePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: HomeLoanFormWidget.routeName,
          path: HomeLoanFormWidget.routePath,
          builder: (context, params) => HomeLoanFormWidget(),
        ),
        FFRoute(
          name: EducationLoanFormWidget.routeName,
          path: EducationLoanFormWidget.routePath,
          builder: (context, params) => EducationLoanFormWidget(),
        ),
        FFRoute(
          name: BussinesLoanFormWidget.routeName,
          path: BussinesLoanFormWidget.routePath,
          builder: (context, params) => BussinesLoanFormWidget(),
        ),
        FFRoute(
